...
ll AtMostKElementsDistincIntegers(int &n, vector<int> &arr, int k)
{
...
void solve()
{
    ...
    ll FinalAnswer = AtMostKElementsDistincIntegers(n, arr, k);

    FinalAnswer -= AtMostKElementsDistincIntegers(n, arr, k - 1);
