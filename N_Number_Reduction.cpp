...
// int minInt(int x, int k)
// {
//     string s = to_string(x); // convert x to string

//     // Apply the operation k times, removing one digit at a time.
//     for (int i = 0; i < k; i++)
//     {
//         int n = s.length();
//         int minIdx = -1;

//         // Find the index of the minimum digit in the string.
//         for (int j = 0; j < n; j++)
//         {
//             if (s[j] != '0' || j == 0)
//             { // skip leading zeroes
//                 if (minIdx == -1 || s[j] < s[minIdx])
//                 {
//                     minIdx = j;
//                 }
//             }
...
//         // Remove the minimum digit.
//         s.erase(minIdx, 1);

//         // Check if the resulting number is valid.
//         if (s[0] == '0')
//         {
//             break; // number is not valid, stop applying the operation
//         }
//     }
...
// // Returns the minimum positive integer that can be obtained from x by applying
// // the operation exactly k times.
// int minInt(int x, int k)
// {
//     string s = to_string(x); // convert x to string

//     // Check if the number of digits in x is equal to or greater than k.
//     if (k >= s.length())
//     {
//         return x; // return x without applying the operation
//     }
...
//     // Find the index of the last occurrence of the minimum digit in the string.
//     for (int j = 0; j < n; j++) {
//       if (s[j] != '0' || j == 0) { // skip leading zeroes
//         if (minIdx == -1 || s[j] < s[minIdx]) {
//           minIdx = j;
//         }
//       }
...
//     // Remove the last occurrence of the minimum digit.
//     s.erase(s.rfind(s[minIdx]), 1);
