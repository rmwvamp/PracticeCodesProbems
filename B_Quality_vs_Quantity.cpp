...
void solve()
{
    ...
    if (n % 2) // odd
    {
        for (int i = 1; i <= n / 2; i++) // from 0 to n/2-1
        {
            /* code */
            RedSum += CopiedArray[i];
        }
        for (int i = n / 2 + 1; i <= n; i++) // from n/2 to n-1
        {
            /* code */
            BlueSum += CopiedArray[i];
        }
    }
    else
    {
        ...
        for (int i = n / 2; i <= n; i++) // from n/2 to n-1
        {
            /* code */
            BlueSum += CopiedArray[i];
        }
    }
    RedSum > BlueSum ? cout << "YES" << endl : cout << "NO" << endl;
}
int main()
{
