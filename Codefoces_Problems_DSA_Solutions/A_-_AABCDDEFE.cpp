            ...
            for (int k = 0; k <= 9; k++)
            {
                ...
                for (int x = 0; x <= 9; x++)
                {
                    ...
                    for (int y = 0; y <= 9; y++)
                    {
                        ...
                        {
                            /* code */
                            temp += to_string(i) + to_string(i); // s1 s2
                            temp += to_string(j);                // s1 s2
                            temp += to_string(k);                // s1 s2
                            temp += to_string(x) + to_string(x); // s1 s2
                            temp += to_string(y);                // s1 s2
                            temp += to_string(z);
                            temp += to_string(y);
                            // s1 s2
                            mmp[temp]++;
